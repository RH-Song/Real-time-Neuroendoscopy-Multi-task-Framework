...
if __name__ == '__main__':
    ...
    source_pic_root_path = '/home/raphael/Desktop/data/surgery/surgery_VOCstyle/JPEGImages'
    source_xml_root_path = '/home/raphael/Desktop/data/surgery/surgery_VOCstyle/Annotations'
    target_pic_dir = '/home/raphael/Desktop/data/surgery/surgery_aug_VOCstyle/JPEGImages'
    target_xml_dir = '/home/raphael/Desktop/data/surgery/surgery_aug_VOCstyle/Annotations'
    ...
    for parent, _, files in os.walk(source_pic_root_path):
        for file in files:
            ...
            while cnt < need_aug_num:
                ...
                cv2.imwrite(os.path.join(target_pic_dir, file[:-4]+'_'+str(cnt)+'.jpg'), auged_img)
                generate_xml(file[:-4]+'_'+str(cnt)+'.jpg', auged_bboxes, auged_img.shape, target_xml_dir)
